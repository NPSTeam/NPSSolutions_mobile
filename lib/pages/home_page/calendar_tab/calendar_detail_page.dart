...
class CalendarDetailPage extends StatefulWidget {
  const CalendarDetailPage({super.key, required this.event});
...
class _CalendarDetailPageState extends State<CalendarDetailPage> {
  ...
  void initState() {
    ...
    _descriptionController.text = widget.event.extendedProps!.desc!;
            ...
            PopupMenuButton(
              ...
              onSelected: (value) async {
                if (value == 'DELETE') {
                  ...
                  await calendarController.deleteEvent(widget.event.id!);
                ...
                children: [
                    ...
                    child: InputDecorator(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<int>(
                          // isExpanded: true,
                          value: widget.event.extendedProps?.label,
                          hint: Text(
                            'Select Label',
                            style: TextStyle(
                              fontSize: 14,
                          ...
                          onChanged: (value) {
                            setState(() =>
                                widget.event.extendedProps?.label = value);
                          },
                        ),
                      ),
                    ),
                  ...
                  WidgetDateTimeField(
                    controller: TextEditingController(
                        text:
                            UtilFunction.dateTimeToString(widget.event.start)),
                    initialValue: widget.event.start,
                  ...
                  WidgetDateTimeField(
                    controller: TextEditingController(
                        text: UtilFunction.dateTimeToString(widget.event.end)),
